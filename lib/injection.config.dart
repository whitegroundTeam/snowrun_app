...
import 'application/user/user_bloc.dart' as _i24;
...
import 'utils/injectable_module.dart' as _i26;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i22.SignInFormBloc>(
      () => _i22.SignInFormBloc(gh<_i12.IAuthRepository>()));
  gh.factory<_i23.SignUpFormBloc>(
      () => _i23.SignUpFormBloc(gh<_i12.IAuthRepository>()));
  gh.factory<_i24.UserBloc>(() => _i24.UserBloc(gh<_i18.IUserRepository>()));
  gh.factory<_i25.AuthBloc>(() => _i25.AuthBloc(gh<_i12.IAuthRepository>()));
  return getIt;
}
