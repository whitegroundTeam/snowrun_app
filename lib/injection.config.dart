...
import 'application/permission/permission_actor/permission_actor_bloc.dart'
    as _i7;
import 'application/place/place_bloc.dart' as _i23;
import 'application/profile/profile_bloc.dart' as _i24;
import 'application/riding/riding_actor/riding_actor_bloc.dart' as _i25;
import 'application/riding/riding_detail/riding_detail_bloc.dart' as _i26;
import 'application/riding/riding_form/riding_form_bloc.dart' as _i27;
import 'application/riding/riding_list/riding_list_bloc.dart' as _i28;
import 'application/user/user_bloc.dart' as _i31;
...
import 'domain/riding/i_riding_repository.dart' as _i18;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i18.IRidingRepository>(
      () => _i19.RidingRepository(gh<_i11.CoreApi>()));
  gh.lazySingleton<_i20.IUserRepository>(
      () => _i21.UserRepository(gh<_i11.CoreApi>()));
  gh.factory<_i22.LocationBloc>(
      () => _i22.LocationBloc(gh<_i14.ILocationRepository>()));
  gh.factory<_i23.PlaceBloc>(() => _i23.PlaceBloc(gh<_i16.IPlaceRepository>()));
  gh.factory<_i24.ProfileBloc>(
      () => _i24.ProfileBloc(gh<_i20.IUserRepository>()));
  gh.factory<_i25.RidingActorBloc>(
      () => _i25.RidingActorBloc(gh<_i18.IRidingRepository>()));
  gh.factory<_i26.RidingDetailBloc>(
      () => _i26.RidingDetailBloc(gh<_i18.IRidingRepository>()));
  gh.factory<_i27.RidingFormBloc>(
      () => _i27.RidingFormBloc(gh<_i18.IRidingRepository>()));
  gh.factory<_i28.RidingListBloc>(
      () => _i28.RidingListBloc(gh<_i18.IRidingRepository>()));
  gh.factory<_i29.SignInFormBloc>(
      () => _i29.SignInFormBloc(gh<_i12.IAuthRepository>()));
  gh.factory<_i30.SignUpFormBloc>(
      () => _i30.SignUpFormBloc(gh<_i12.IAuthRepository>()));
  gh.factory<_i31.UserBloc>(() => _i31.UserBloc(gh<_i20.IUserRepository>()));
  gh.factory<_i32.AuthBloc>(() => _i32.AuthBloc(gh<_i12.IAuthRepository>()));
  return getIt;
}
