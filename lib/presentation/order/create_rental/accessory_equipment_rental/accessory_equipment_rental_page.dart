...
class AccessoryEquipmentRentalPage extends StatefulWidget {
  const AccessoryEquipmentRentalPage({
    super.key,
  });

  @override
  State createState() => AccessoryEquipmentRentalPageState();
}

class AccessoryEquipmentRentalPageState
    extends State<AccessoryEquipmentRentalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<RentalActorBloc, RentalActorState>(
      ...
      builder: (context, state) {
        final selectedAccessoryEquipments = state
            .rental.accessoryEquipmentsRentalProduct.productOptions
            .getOrCrash();
        if (selectedAccessoryEquipments.isNotEmpty) {
          return Padding(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      CommonDetector(
                        onTap: () {
                          final accessoryEquipmentsRentalProduct = rentalShop
                              ...
                              .firstWhere(
                                (product) =>
                                    ...
                                    state.rental
                                        .accessoryEquipmentsRentalProduct.id
                                        .getOrCrash(),
                                orElse: () =>
                                    throw Exception('Product not found'),
                              );

                          final updatedaccessoryEquipmentsRentalProduct =
                              accessoryEquipmentsRentalProduct.copyWith(
                            productOptions: ListVO(
                                accessoryEquipmentsRentalProduct.productOptions
                                    .getOrCrash()
                                    .map((option) {
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: selectedAccessoryEquipments.length,
                        itemBuilder: (context, index) {
                          final selectedProductOption =
                              selectedAccessoryEquipments[index];
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: rentalShop.accessoryEquipmentProducts
                        .getOrCrash()
                        .length,
                    itemBuilder: (context, index) {
                      var product = rentalShop.accessoryEquipmentProducts
                          .getOrCrash()[index];
